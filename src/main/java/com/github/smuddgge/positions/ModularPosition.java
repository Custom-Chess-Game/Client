package com.github.smuddgge.positions;
...
public class ModularPosition {
    ...
    public void calculate() {
        ...
        int centerX = (Client.getConfig().getScreenSize().get(0) / 2) - (this.width / 2);
        int centerY = (Client.getConfig().getScreenSize().get(1) / 2) - (this.height / 2);
